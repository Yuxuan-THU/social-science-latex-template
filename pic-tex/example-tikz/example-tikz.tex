...
%  FIGURE WRAPPER: includes the pre-compiled PDF (example-tikz.pdf) produced
%  from example-tikz-source.tex in the same folder. Input this file from
%  text/APPENDIX/figures.tex or any other place.
...
\begin{figure}[htbp]
  ...
  \vspace{0.5em}
  \caption{Stylized Dynamics of Ruler Power Security (Placeholder Figure)}
