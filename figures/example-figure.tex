...
%  \includegraphics{example-figure.pdf} (graphicspath is {figures/}).
%
%  Recommended figure workflow: keep the standalone TikZ source and its
%  compiled PDF side by side in figures/, with the same file name.
%  图片工作流：TikZ 源文件与编译产物同名，同置于 figures/ 目录。
%
